...
cl /nologo /W4 /EHsc /utf-8 /std:c++17 /MT /wd4996 ^
  ...
  "%ROOT%\shared\input\src\HanjaPolicy.cpp" "%ROOT%\raindrop-runtime\producer\ko\korean_hanja_data_provider.cpp" "%ROOT%\raindrop-runtime\producer\ko\korean_hanja_user_data.cpp" ^
