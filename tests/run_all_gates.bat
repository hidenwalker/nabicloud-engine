...
REM     E14 spellcheck gates(run_spellcheck_gates.bat, 14 selftest)도 별도 INTEG 블록으로 배선
...
:run_spellcheck
REM Aggregates the 14 TSF spellcheck selftests (grammar_rule/grammar_facts/boundary_classify/
REM   confusion_dict/grammar_seed_integration/chained_factset/correct_suggest/correct_suggest_policy/
REM   morph_analyzer/hanja_dict/predict_dict/lexstore/retro_correct/grammar_golden_vector). Own exit
REM   0/1; INTEG-wired here. (Roster sealed by M0 baseline manifest, D I0 2026-07-13.)
